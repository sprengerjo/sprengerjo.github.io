...
var _sprengerjo$elm_sandbox$GameOfLife$countNeighbours = F2(
	function (cell, cells) {
		return A2(
			_elm_community$list_extra$List_Extra$count,
			function (y) {
				return _elm_lang$core$Native_Utils.eq(y, cell);
			},
			cells);
	});
var _sprengerjo$elm_sandbox$GameOfLife$flatten2D = function (list) {
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (x, y) {
...
var _sprengerjo$elm_sandbox$GameOfLife$neighbours = function (cell) {
	var d = {
		ctor: '::',
		_0: 1,
		_1: {
			...
			function (x) {
				return A2(
					...
					function (y) {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Tuple$first(cell) - y,
							_1: _elm_lang$core$Tuple$second(cell) - x
						};
					},
					d);
			},
...
var _sprengerjo$elm_sandbox$GameOfLife$alive = F2(
	function (n, isAlive) {
		return (_elm_lang$core$Native_Utils.eq(n, 2) && isAlive) || _elm_lang$core$Native_Utils.eq(n, 3);
	});
var _sprengerjo$elm_sandbox$GameOfLife$filterLiving = F2(
	function (livingCells, xs) {
		return A2(
			_elm_lang$core$List$filter,
			function (x) {
				return A2(
					_sprengerjo$elm_sandbox$GameOfLife$alive,
					A2(_sprengerjo$elm_sandbox$GameOfLife$countNeighbours, x, xs),
					A2(_elm_lang$core$List$member, x, livingCells));
			},
			xs);
	});
var _sprengerjo$elm_sandbox$GameOfLife$next = function (cells) {
	return _elm_community$list_extra$List_Extra$unique(
		A2(
			_sprengerjo$elm_sandbox$GameOfLife$filterLiving,
			cells,
			_sprengerjo$elm_sandbox$GameOfLife$flatten2D(
				A2(
					_elm_lang$core$List$map,
					function (x) {
						return _sprengerjo$elm_sandbox$GameOfLife$neighbours(x);
					},
					cells))));
};

var _sprengerjo$elm_sandbox$GameOfLifeUi$checkbox = F3(
	function (msg, name, step) {
		return A2(
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$checked(step),
								_1: {ctor: '[]'}
							}
						}
					},
...
var _sprengerjo$elm_sandbox$GameOfLifeUi$groupInto = F2(
	function (n, lst) {
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(lst),
			0) ? {ctor: '[]'} : {
			ctor: '::',
			_0: A2(_elm_lang$core$List$take, n, lst),
			_1: A2(
				_sprengerjo$elm_sandbox$GameOfLifeUi$groupInto,
				n,
				A2(_elm_lang$core$List$drop, n, lst))
		};
	});
var _sprengerjo$elm_sandbox$GameOfLifeUi$livingCells = function (grid) {
	return A3(
		_elm_community$list_extra$List_Extra$indexedFoldl,
		F3(
			function (y, cells, curr) {
				return A2(
					_elm_lang$core$List$append,
					curr,
					A2(
						...
						A2(_elm_community$list_extra$List_Extra$elemIndices, true, cells)));
			}),
		{ctor: '[]'},
		grid);
};
var _sprengerjo$elm_sandbox$GameOfLifeUi$toggle = F2(
	function (pos, grid) {
		return A3(
			_elm_community$list_extra$List_Extra$updateAt,
...
var _sprengerjo$elm_sandbox$GameOfLifeUi$toggleCells = F2(
	function (grid, cells) {
		return A3(
			_elm_lang$core$List$foldr,
			F2(
				function (cell, curr) {
					return A2(_sprengerjo$elm_sandbox$GameOfLifeUi$toggle, cell, curr);
				}),
			grid,
			cells);
	});
var _sprengerjo$elm_sandbox$GameOfLifeUi$initGrid = function (n) {
	return A2(
		_elm_lang$core$List$repeat,
		n,
		A2(_elm_lang$core$List$repeat, n, false));
};
var _sprengerjo$elm_sandbox$GameOfLifeUi$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: {
			grid: _sprengerjo$elm_sandbox$GameOfLifeUi$initGrid(flags.n),
			step: false,
			stepCount: 0,
			initial: flags.n
		},
...
var _sprengerjo$elm_sandbox$GameOfLifeUi$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Toggle':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							grid: A2(_sprengerjo$elm_sandbox$GameOfLifeUi$toggle, _p0._0, model.grid)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Next':
			...
			case 'Tick':
				return {
					ctor: '_Tuple2',
					_0: function () {
						var cells = _sprengerjo$elm_sandbox$GameOfLifeUi$livingCells(model.grid);
						var anythingAlive = _elm_lang$core$Native_Utils.cmp(
							_elm_lang$core$List$length(cells),
							0) > 0;
						return model.step ? _elm_lang$core$Native_Utils.update(
							model,
							{
								stepCount: model.stepCount + 1,
								step: anythingAlive,
								grid: A2(
									_sprengerjo$elm_sandbox$GameOfLifeUi$toggleCells,
									_sprengerjo$elm_sandbox$GameOfLifeUi$initGrid(model.initial),
									_sprengerjo$elm_sandbox$GameOfLife$next(cells))
							}) : model;
					}(),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _sprengerjo$elm_sandbox$GameOfLifeUi$cellSize = 10;
var _sprengerjo$elm_sandbox$GameOfLifeUi$cellStyle = function (on) {
	return _elm_lang$html$Html_Attributes$style(
		{
			...
			_1: {
				...
				_0: {
					...
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(_sprengerjo$elm_sandbox$GameOfLifeUi$cellSize),
						'px')
				},
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'border-width', _1: '0.5px'},
								_1: {ctor: '[]'}
							}
						}
					}
...
var _sprengerjo$elm_sandbox$GameOfLifeUi$stepDelay = 200;
var _sprengerjo$elm_sandbox$GameOfLifeUi$Model = F4(
	function (a, b, c, d) {
		return {grid: a, step: b, stepCount: c, initial: d};
	});
var _sprengerjo$elm_sandbox$GameOfLifeUi$Flags = function (a) {
	return {n: a};
};
var _sprengerjo$elm_sandbox$GameOfLifeUi$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _sprengerjo$elm_sandbox$GameOfLifeUi$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _sprengerjo$elm_sandbox$GameOfLifeUi$stepDelay, _sprengerjo$elm_sandbox$GameOfLifeUi$Tick);
};
var _sprengerjo$elm_sandbox$GameOfLifeUi$Next = {ctor: 'Next'};
var _sprengerjo$elm_sandbox$GameOfLifeUi$Toggle = F2(
	function (a, b) {
		return {ctor: 'Toggle', _0: a, _1: b};
	});
var _sprengerjo$elm_sandbox$GameOfLifeUi$cell = F3(
	function (x, y, on) {
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Events$onClick(
					A2(
						_sprengerjo$elm_sandbox$GameOfLifeUi$Toggle,
						{ctor: '_Tuple2', _0: x, _1: y},
						on)),
				_1: {
					ctor: '::',
					_0: _sprengerjo$elm_sandbox$GameOfLifeUi$cellStyle(on),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _sprengerjo$elm_sandbox$GameOfLifeUi$row = F2(
	function (x, row) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			A2(
				_elm_lang$core$List$indexedMap,
				_sprengerjo$elm_sandbox$GameOfLifeUi$cell(x),
				row));
	});
var _sprengerjo$elm_sandbox$GameOfLifeUi$view = function (_p1) {
	var _p2 = _p1;
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				A2(_elm_lang$core$List$indexedMap, _sprengerjo$elm_sandbox$GameOfLifeUi$row, _p2.grid)),
			_1: {
				ctor: '::',
				_0: A2(
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A3(_sprengerjo$elm_sandbox$GameOfLifeUi$checkbox, _sprengerjo$elm_sandbox$GameOfLifeUi$Next, 'run', _p2.step),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'generation: ',
										_elm_lang$core$Basics$toString(_p2.stepCount))),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _sprengerjo$elm_sandbox$GameOfLifeUi$main = _elm_lang$html$Html$programWithFlags(
	{init: _sprengerjo$elm_sandbox$GameOfLifeUi$init, view: _sprengerjo$elm_sandbox$GameOfLifeUi$view, update: _sprengerjo$elm_sandbox$GameOfLifeUi$update, subscriptions: _sprengerjo$elm_sandbox$GameOfLifeUi$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (n) {
		...
		A2(_elm_lang$core$Json_Decode$field, 'n', _elm_lang$core$Json_Decode$int)));
var _sprengerjo$elm_sandbox$GameOfLifeUi$Initialize = function (a) {
	return {ctor: 'Initialize', _0: a};
};

var Elm = {};
Elm['GameOfLifeUi'] = Elm['GameOfLifeUi'] || {};
if (typeof _sprengerjo$elm_sandbox$GameOfLifeUi$main !== 'undefined') {
    _sprengerjo$elm_sandbox$GameOfLifeUi$main(Elm['GameOfLifeUi'], 'GameOfLifeUi', undefined);
}
